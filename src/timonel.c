...
int main(void) {
    /* ___________________
      ...
      |___________________|
    */
#if APP_AUTORUN_ONLY_ON_BOOT 
   uint8_t bootcause = MCUSR;
#endif
...
#endif                                             // ENABLE_LED_UI
#if APP_AUTORUN
#if APP_AUTORUN_ONLY_ON_BOOT   // if the app has cleared MCUSR and jumped to Timonel
                if (bootcause && (exit_delay-- == 0)) {
#else
                if (exit_delay-- == 0) {
#endif
                    // ========================================
